...
Exploratory data analysis: make two contingency tables with `Admit` as the response variable and `Gender` as the predictor variable. One table should have counts and the other table should have percentages. (Both tables should include the marginal distribution at the bottom.)
