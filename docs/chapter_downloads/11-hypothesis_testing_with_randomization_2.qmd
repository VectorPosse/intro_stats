...
The template below is exactly the same as in the appendix ([Rubric for inference](https://vectorposse.github.io/intro_stats/Rubric.html)) up to the part about confidence intervals which we haven't learned yet.
