...
In this chapter, we will learn about the concept of correlation which measures the strength of the linear relationship between two numerical variables.
...
We load the now-standard `tidyverse` package.
...
Consult at least two sources for each term. Then, in your own words (not copied and pasted from any of the websites you consulted), explain what these terms mean.
...
- A value close to zero indicates little or no correlation.
