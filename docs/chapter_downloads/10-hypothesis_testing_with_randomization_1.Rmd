...
The template below is exactly the same as in the files (`.Rmd` [here](https://vectorposse.github.io/intro_stats/chapter_downloads/rubric_for_inference.Rmd) and `.nb.html` [here](https://vectorposse.github.io/intro_stats/chapter_downloads/rubric_for_inference.nb.html))) up to the part about confidence intervals which we haven't learned yet.
