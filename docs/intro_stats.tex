...
https://vectorposse.github.io/intro\_stats/chapter\_downloads/02-using-r-markdown.Rmd
...
\addcontentsline{toc}{section}{Section header}
...
\addcontentsline{toc}{subsection}{Not quite as big}
