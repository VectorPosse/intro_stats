...
Summarize in your own words what information is contained in the `hp_grand_finale` data frame. In other words, what are the numbers in the `max_delay` column telling us? Be specific!
