...
After we've installed the package (the one-time process we completed above), we will need to load the package in every R session in which we want to use it. Since the `palmerpenguins` package has been installed, you can now type this at the command prompt:
...
Let's test that claim. Type the following:
...
![Ad&eacute;lie Penguin, By Andrew Shiva&nbsp;/&nbsp;Wikipedia, <a href="https://creativecommons.org/licenses/by-sa/4.0" title="Creative Commons Attribution-Share Alike 4.0">CC BY-SA 4.0</a>, <a href="https://commons.wikimedia.org/w/index.php?curid=46714803">Link</a>](https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Hope_Bay-2016-Trinity_Peninsula%E2%80%93Ad%C3%A9lie_penguin_%28Pygoscelis_adeliae%29_04.jpg/800px-Hope_Bay-2016-Trinity_Peninsula%E2%80%93Ad%C3%A9lie_penguin_%28Pygoscelis_adeliae%29_04.jpg "Ad&eacute;lie Penguin, By Andrew Shiva / Wikipedia, CC BY-SA 4.0, https://commons.wikimedia.org/w/index.php?curid=46714803")
