...
Go to the upper-right corner of the screen. Click the arrow next to the project name to access the project drop-down menu and select "New Project". Generally, you will then select "New Directory". (The only exception would be if you have already created a folder somewhere in which you want your R Markdown file to reside. In that case, click "Existing Directory".) Next, click "Empty Project", and then give your project a name where is asks for "Directory name". When you're done, click "Create Project".
