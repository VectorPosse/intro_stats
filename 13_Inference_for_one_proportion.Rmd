...
[Remember that you are using the full `heartTr` data, so your sample size should be larger here than in the example above.]
...
[Remember that you are using the full `heartTr` data, so the number of successes and failures will be different here than in the example above.]
...
[Be sure to use `heartTr` everywhere and not `heartTr2`!]
