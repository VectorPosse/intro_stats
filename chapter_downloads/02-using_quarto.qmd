...
Type the following commands at the Console:^[If you get an authorization error, that means you are accessing RStudio through a managed local server and you'll need your admin to install the package for you.]
