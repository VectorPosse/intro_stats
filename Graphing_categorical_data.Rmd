...
Choose two categorical variables of interest from the `birthwt` data set. (Choose at least one variable other than `race` or `smoke`.) Turn them into factor variables with meaningful labels. Create a new data frame containing both variables. Identify one as response and one as explantory. Then create a side-by-side bar chart. Comment on the association (or independence) of the two variables.
