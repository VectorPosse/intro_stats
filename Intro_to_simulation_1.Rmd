...
Now imagine that you and all the other students at Westminster College (say, 2000 students total) all go out and conduct surveys of 100 random U.S. adults. Write some R code that simulates this. Plot a histogram of the results. (Hint: you'll need `do(2000) *` in there.) Use the proportion of supporters (`prop`), not the raw count of supporters (`heads`).
