...
When assessing the differences between groups, there are two numbers that are important.
...
[You should type `?uis` at the Console to read the help file and use `View` to look at the spreadsheet view of the data. You have already Googled the Beck Depression Score.]
