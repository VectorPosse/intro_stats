...
This book assumes you are using the R language using the RStudio platform. If you are using this book for a class, your teacher will let you know if you need to download R and RStudio on your own device or if you will be accessing R and RStudio installed on a central server and accessing them through a web browser.
