...
As before, if for some reason you're getting results that are different from the ones reported in the text, the easiest thing to do is "Restart R and Run All Chunks" from the "Run" menu.
