...
Another place you will see the three colon "tags" will be when providing answers to homework questions. It will start with `::: {.answer}` and and with `:::`. While you should be careful not to modify the light grey text in those lines, you can and should modify the plain text that lies between the colon tag fences. Let's try it: 

::: {.answer}

Replace this text here with something else. (Anything you want to type here is fine.) Then preview the document and see how it appears in the HTML file.
