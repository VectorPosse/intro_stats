...
We can make horizontal rules. There are lots of ways of doing this, but we prefer a bunch of asterisks in a row (at least three---I've used five for more visual impact in the Quarto document):
...
The easiest solution is to use Ctrl-F or Cmd-F. This will open the "Find" tool. Start typing r 2 + 3% and it will take you to the problematic spot.
