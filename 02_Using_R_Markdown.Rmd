...
R Markdown is a special version of Markdown that also allows you to include R code alongside the text. This document is called an R Notebook file.
...
To get rid of the error above, uncomment the line `my_variable <- 42`.
