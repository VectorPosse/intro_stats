...
Now create a scatterplot to visualize the relationship between the birth weight of the baby the mother's age. Be careful to make sure you put the variables on the right axes!
