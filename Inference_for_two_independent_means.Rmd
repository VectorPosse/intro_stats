...
[Type `?cabbages` to read the help file.]
...
The individual group histograms look reasonably normal, although it's a bit hard to tell with a sample size of 30 in each group. Here are the QQ plots to give us another way to ascertain normality of the data.
...
So we will use a t model with `r cabbage_test$parameter` degrees of freedom.
