...
Also note that the function spits about a bunch of extra crap we don't care about. This goes away if you use the command inline when you knit to PDF. (Go ahead and knit to PDF so you can see the effect.)
