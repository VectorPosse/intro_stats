...
There are many more formatting tricks available. For a good resource on all R Markdown stuff, click on [this link](http://www.rstudio.com/wp-content/uploads/2016/03/rmarkdown-cheatsheet-2.0.pdf) for a "cheat sheet". And note in the previous sentence the syntax for including hyperlinks in your document.
